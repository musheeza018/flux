...
Yes, image updates are supported for `HelmRelease` as well as any other Kubernetes custom resources stored in Git. See the [Image Update Guide](/flux/workflows/image-update/#configure-image-update-for-custom-resources) for more information.
